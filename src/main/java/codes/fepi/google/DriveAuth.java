...
public class DriveAuth {
    private static final String APPLICATION_NAME = "yt-java-schedule";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = DriveAuth.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
